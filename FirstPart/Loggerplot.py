...
deplaceflag = np.arange(0,10,0.1)
...
for i in range(100):
     ...
     y[i]=line.split()[1]
     z[i]=line.split()[2]
     deplaceflag[i]=line.split()[3]

     

fig,ax = plt.subplots(2, 1)
for i in range(100):
    ax[1].plot([t[i],t[i]],[0,deplaceflag[i]],color="orange", linewidth=2.5, linestyle="-")
    ax[1].scatter([t[i],], [deplaceflag[i],],50 , color="purple")
